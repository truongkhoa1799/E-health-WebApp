    ...
    _makeManagementRequest(request, options = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const translatedError = coreAmqp.translate(err);
                logger.warning(`An error occurred while making the request to $management endpoint: ${translatedError === null || translatedError === void 0 ? void 0 : translatedError.name}: ${translatedError === null || translatedError === void 0 ? void 0 : translatedError.message}`);
                logErrorStackTrace(translatedError);
                throw translatedError;
            }
        });
                ...
                return new Promise((resolve, reject) => tslib.__awaiter(this, void 0, void 0, function* () {
                    ...
                    const rejectOnAbort = () => tslib.__awaiter(this, void 0, void 0, function* () {
                        ...
                        try {
                            ...
                            reject(new abortController.AbortError("The receive operation has been cancelled by the user."));
                        }
                    });
        ...
        const sendEventPromise = () => new Promise((resolve, reject) => tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            if (this._sender.sendable()) {
                ...
                try {
                    ...
                    const translatedError = coreAmqp.translate(err.innerError || err);
                    logger.warning("[%s] An error occurred while sending the message %s", this._context.connectionId, `${translatedError === null || translatedError === void 0 ? void 0 : translatedError.name}: ${translatedError === null || translatedError === void 0 ? void 0 : translatedError.message}`);
                    logErrorStackTrace(translatedError);
                    return reject(translatedError);
                }
                finally {
